    ...
    if (isset($_GET['error'])){
        ...
        switch ($_GET['error']){
            ...
            case '4':
                ...
                break;
            case '5':
                $return = "Le mot de passe n'a pas de majuscule ou de chiffres  ou a moins de 8 caractères";
                break;
        }
    }
...
<h1 id="miniChat">MinichatProjet </h1>

<main id="connection_registration">

    <button id="buttonConnection" type="button" y" data-bs-toggle="modal" data-bs-target="#modalConnexion">Connexion</button>
    ...
    <!-- registration -->
    <button id="buttonRegistration" type="button"  data-bs-toggle="modal" data-bs-target="#modalRegistration">Inscription</button>
